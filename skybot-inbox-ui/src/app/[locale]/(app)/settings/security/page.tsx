...
export default function SecurityPage() {
  ...
  return (
    <div className="space-y-6">
       <div>
          <h2 className="ui-pageTitle">Security</h2>
          <p className="ui-pageSubtitle">Manage your account security and credentials.</p>
       </div>
       ...
       <form onSubmit={handleSubmit} className="ui-card max-w-lg">
          ...
          <div className="ui-card__body space-y-4">
             ...
             <div>
                <label className="text-xs font-medium mb-1.5 block text-muted-foreground">Current Password</label>
             ...
             <div className="grid grid-cols-2 gap-4">
               <div>
                  <label className="text-xs font-medium mb-1.5 block text-muted-foreground">New Password</label>
                  <input required type="password" className="ui-input w-full" placeholder="••••••••" />
               </div>
               <div>
                  <label className="text-xs font-medium mb-1.5 block text-muted-foreground">Confirm</label>
                  <input required type="password" className="ui-input w-full" placeholder="••••••••" />
               </div>
             </div>
          </div>
